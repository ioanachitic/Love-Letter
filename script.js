...
window.onload=function(){
	alert("Page is loaded");//asta e pt mine 
	pachet=crearePachet();
...
function GardianJ(){
    ...
    x.setAttribute("id","1");
    document.getElementById("j_j").appendChild(x);
    document.getElementById("j_j").innerHTML += " Gardian "+"<br>";
    ...
    x.setAttribute("id","2");
    document.getElementById("j_j").appendChild(x);
    document.getElementById("j_j").innerHTML +=" Preot "+"<br>";
    ...
    x.setAttribute("id","3");
    document.getElementById("j_j").appendChild(x);
    document.getElementById("j_j").innerHTML += " Baron " + "<br>";
    ...
    x.setAttribute("id","4");
    document.getElementById("j_j").appendChild(x);
    document.getElementById("j_j").innerHTML += " Camerista " + "<br>";
    ...
    x.setAttribute("id","5");
    document.getElementById("j_j").appendChild(x);
    document.getElementById("j_j").innerHTML += " Print " + "<br>";
    ...
    x.setAttribute("id","6");
    document.getElementById("j_j").appendChild(x);
    document.getElementById("j_j").innerHTML += " Rege " + "<br>";
    ...
    x.setAttribute("id","7");
    document.getElementById("j_j").appendChild(x);
    document.getElementById("j_j").innerHTML += " Contesa " + "<br>";
    ...
    x.setAttribute("id","8");
    document.getElementById("j_j").appendChild(x);
    document.getElementById("j_j").innerHTML += " Printesa " + "<br>";
}
